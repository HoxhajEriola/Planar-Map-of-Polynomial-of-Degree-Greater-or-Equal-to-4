...
--time LNormalize (B);   --used 222.676 seconds
...
--time Veronese (B)    --used  218.882 seconds
...
--time P= PointVeronese(B)      --used 225.291 seconds
...
--time ParametrizationVeronese(B) -- 1145.51 seconds
...
time PlanarMap(B) --1126.1 seconds
